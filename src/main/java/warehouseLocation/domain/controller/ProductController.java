...
//  public String search(ProductReqDto body) {
...
//  public String productEdit(@RequestBody ProductReqDto body, @PathVariable({productId})) {
//
//    System.out.println("nice");
...
//  public String locationAdd(@RequestBody ProductReqDto body, @Parameter(description = "위치 등록")) {
